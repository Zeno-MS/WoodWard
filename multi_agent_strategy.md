...
3.  **You (The Editor)**: Copy the content of that dispatch file into the specialized AI's interface (Copilot Chat).
...
*   **Best Model**: **Claude Opus 4.6** (Best Prose) or **Gemini 3 Pro** (Deep Context).
...
*   **Best Model**: **GPT-5.3-Codex** (Top Tier Reasoning).
*   **Why**: This model excels at complex logical deduction, vital for finding contractual loop-holes and indemnification risks.
*   **Token Strategy**:
...
*   **Best Model**: **Claude Sonnet 4.5** (Fast Coding) or **GPT-5.2**.
*   **Why**: These models demonstrate superior Python code generation for data science (Pandas/NumPy).
*   **Token Strategy**:
