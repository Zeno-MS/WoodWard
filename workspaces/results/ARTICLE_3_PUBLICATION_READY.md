...
* **Incentive misalignment:** when labor is purchased through Object 7, the accounting optics differ from Objects 2 and 3, even if the district is still purchasing labor.
...
**Disclosure:** The selected schedule steps (**VEA Step 5** for certificated roles and **VAESP Step 3** for classified roles) are **mid‑career baselines**. They are **not** the minimum (entry) step and **not** the maximum (top) step; the intent is to avoid cherry‑picking extremes.
...
State payroll data (OSPI S-275) documents a districtwide reduction in staffed FTE from **2,736.83** to **2,519.90** — a net loss of **216.93 FTE** — while staffing-vendor spending hit **$13,326,622** in FY24–25.
...
This is a districtwide proxy. OSPI's S-275 raw files for SPED-specific duty roots were blocked by dead server links at the time of extraction.

**The inference:** if payroll FTE falls while purchased staffing spend rises, the district has not only reduced labor — it has also **changed how labor is purchased**.

That shift describes a structural incentive: in austerity, districts face pressure to reduce salary lines, and Object 7 becomes a mechanism for sustaining services without adding headcount. Whether VPS leadership explicitly relied on this accounting distinction when making staffing decisions is not documented in the public record — but the structural incentive exists regardless of intent.
...
The legal framework is unambiguous on one point: outsourcing does **not** eliminate the district's responsibility for delivering FAPE. Under IDEA, contracting is a tool to meet obligations, not a liability shield when services are missed. Federal courts have consistently held that the non-delegable duty remains with the LEA regardless of whether services are delivered by employees or contractors (see, e.g., *Florence County Sch. Dist. Four v. Carter*, 510 U.S. 7 (1993); OSPI guidance on LEA obligations under WAC 392-172A).
...
The model does **not** assume all agency hours were paras, or all were specialists. It brackets the premium using known bill-rate bounds and internal make-cost baselines. The premium ranges from $1.6M to $8.3M depending on the assumed role mix, with the SPED Teacher mid-range at $2.5M.
...
Even at the absolute floor rate used in the model, the district pays **$1.64M** above what equivalent internal labor would cost.
...
To test whether Vancouver is unusually dependent on purchased services, we start with a **budget-to-budget** control comparison using OSPI F-195 data. This isolates what districts **planned** to spend in Object 7 before the year unfolded.

### Planned (Budget-to-Budget): Clark County Peer Comparison
...
On paper, Vancouver actually **budgets the least per pupil** for Object 7 of the three reporting districts — **$1,765.67** versus Battle Ground's **$2,649.32** and Evergreen's **$2,161.01**.
...
That shift changes the comparison. Vancouver began the year budgeting below Evergreen, but ended it with Object 7 spending that was **slightly higher than Evergreen's budget on a per‑pupil basis** (**$2,274.77** vs. **$2,161.01**, a difference of about **$114 per pupil**).
...
The public question is whether the district treated that premium as an unavoidable emergency cost — or as a normalized operating model. The data raises a harder question: did VPS take measurable steps to escape the trap? Competitive procurement processes that forced vendors to bid against each other on rates. Aggressive direct-recruitment campaigns targeting the specific SPED roles filling agency slots. Conversion incentives that offset the placement fee. If those steps were taken, they are not visible in the public record reviewed for this series. If they were not taken, then the systemic trap was not merely suffered — it was accepted as a permanent operating cost.
