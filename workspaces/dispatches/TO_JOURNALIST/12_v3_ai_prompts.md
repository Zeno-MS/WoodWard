# Dispatch: V3 AI Thread Initialization Prompts
*Prepared by Antigravity*

Here is exactly what you need to paste as the **first message** into each of the new fresh AI threads, plus the data handoff they need to start working immediately.

---

## 1. To: WOODWARD (ChatGPT 5.2 / 4o)
**Copy/Paste this:**
```text
[Paste the WOODWARD SYSTEM PROMPT from OPERATION_ACCOUNTABILITY_TEAM_ARCHITECTURE_v3.md lines 122-297]
...
## 2. To: NEO (ChatGPT 5.2 / o1-pro)
**Copy/Paste this:**
```text
[Paste the NEO SYSTEM PROMPT from OPERATION_ACCOUNTABILITY_TEAM_ARCHITECTURE_v3.md lines 309-482]
...
## 3. To: CHIEF (Claude Opus 4.5 / 3.5 Sonnet)
**Copy/Paste this:**
```text
[Paste the CHIEF SYSTEM PROMPT from OPERATION_ACCOUNTABILITY_TEAM_ARCHITECTURE_v3.md lines 37-111]
...
## 4. To: SENTINEL (Gemini 3.1 Pro / Advanced)
**Copy/Paste this:**
```text
[Paste the SENTINEL SYSTEM PROMPT from OPERATION_ACCOUNTABILITY_TEAM_ARCHITECTURE_v3.md lines 561-689]
